...
`dsh-taskboard` is a task board plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) Web UI.
...
- Opens the board at `/taskboard` and restores the previous conversation when you leave it.
...
- `src/client/Taskboard.tsx` contains the board and task creation flow.
- `src/client/Taskboard.module.css` contains the scoped board styles.
